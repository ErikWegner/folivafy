    ...
    C: Has<XSpanIdString>  + Clone + Send + Sync + 'static,
{
    ...
    async fn create_collection(
        &self,
        param_create_collection_request: models::CreateCollectionRequest,
        context: &C) -> Result<CreateCollectionResponse, ApiError>
    {
        ...
        // Body parameter
        let body = serde_json::to_string(&param_create_collection_request).expect("impossible to fail to serialize");
        ...
        match response.status().as_u16() {
            201 => {
                ...
                Ok(CreateCollectionResponse::SuccessfulOperation
                    (body)
                )
            }
            400 => {
        ...
        context: &C) -> Result<GetCollectionsResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::CollectionsList>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(GetCollectionsResponse::SuccessfulOperation
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetItemByIdResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::CollectionItemDetails>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(GetItemByIdResponse::SuccessfulOperation
                    (body)
                )
            }
            404 => {
        ...
        context: &C) -> Result<ListCollectionResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(ListCollectionResponse::SuccessfulOperation
                    (body)
                )
            }
            404 => {
        ...
        context: &C) -> Result<StoreIntoCollectionResponse, ApiError>
    {
        ...
        let body = serde_json::to_string(&param_collection_item).expect("impossible to fail to serialize");
                *request.body_mut() = Body::from(body);
        ...
        match response.status().as_u16() {
            201 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = body.to_string();
                Ok(StoreIntoCollectionResponse::SuccessfulOperation
                    (body)
                )
            }
            400 => {
        ...
        match response.status().as_u16() {
            201 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = body.to_string();
                Ok(UpdateItemByIdResponse::SuccessfulOperation
                    (body)
                )
            }
            400 => {
